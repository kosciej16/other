...
class Operations(util.ModuleClsProxy):
    ...
    @classmethod
    def register_operation(cls, name: str, sourcename: Optional[str] = None) -> Callable:
    ...
    def inline_literal(self, value: Union[str, int], type_: None = None) -> "_literal_bindparam":
